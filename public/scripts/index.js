...
//       testDiv.innerHTML = `
//         <label>
//           <input type="checkbox" class="test-checkbox" data-name="${test.name}" data-price="${test.price}">
...
//   try {
//     const response = await fetch(`${serverUrl}/verifyStaffCode`, {
//       method: 'POST',
//       headers: {
//         'Content-Type': 'application/json'
//       },
...
async function deleteSample(id) {
 ...
 document.addEventListener('DOMContentLoaded', (event) => {
  ...
  //     console.log('Sorted Data:', filteredData); // Debugging line
  //     renderSampleTable(filteredData); // Render sorted data
  // }
  ...
  //     console.log('Filtered Data:', filteredData); // Debugging line
  //     renderSampleTable(filteredData); // Render filtered data
  // }
...
// document.getElementById('filterInput').addEventListener('input', fetchAndRenderSamples);
// document.getElementById('referralInput').addEventListener('input', fetchAndRenderSamples);
// document.getElementById('submitUpdateButton').addEventListener('click', submitUpdate);
// document.getElementById('confirmBalanceButton').addEventListener('click', submitBalanceConfirmation);
// document.getElementById('verifyStaffCodeButton').addEventListener('click', verifyStaffCode);



// function applySelectedFilter() {
//   const filterValue = document.getElementById('sample-search-filter').value.toLowerCase();
//   const rows = document.getElementById('sampleTableBody').getElementsByTagName('tr');

//   for (const row of rows) {
//     let found = false;
//     for (let i = 1; i < row.cells.length; i++) { // Start from index 1 to skip the first index column
...
//   const filterValue = document.getElementById('filter-sample').value.toLowerCase();
//   const rows = document.getElementById('sampleTableBody').getElementsByTagName('tr');

//   for (const row of rows) {
//     const statusCell = row.cells[9].textContent.toLowerCase(); // Status cell
//     const fullPayConfirmedCell = row.cells[13].textContent.toLowerCase(); // Full Pay Confirmed cell (adjust index as needed)

//     let showRow = true;

//     if (filterValue !== '') {
//       if (filterValue === 'processing') {
//         if (!(statusCell.includes('processing') || statusCell.includes('awaiting'))) {
//           showRow = false;
//         }
//       } else if (filterValue === 'owing') {
//         if (!(fullPayConfirmedCell.includes('owing') || fullPayConfirmedCell.includes('confirmed'))) {
//           showRow = false;
//         }
//       } else if (filterValue === 'confirmed') {
//         if (!(fullPayConfirmedCell.includes('confirmed'))) {
//           showRow = false;
//         }
//       } else {
//         if (!(statusCell.includes(filterValue) || fullPayConfirmedCell.includes(filterValue))) {
//           showRow = false;
//         }
//       }
//     }
...
// function applySampleSort() {
//   const sortOption = document.getElementById('sample-sort-option').value;

//   const rows = Array.from(document.getElementById('sampleTableBody').getElementsByTagName('tr'));
  
//   rows.sort((rowA, rowB) => {
//     const valueA = getValueForSort(rowA, sortOption);
//     const valueB = getValueForSort(rowB, sortOption);
...
// function getValueForSort(row, sortOption) {
//   switch (sortOption) {
//     case 'name':
//       return row.cells[4].textContent.toLowerCase(); // Adjust index as per your column order
//     case 'quantity':
//       return parseInt(row.cells[1].textContent); // Adjust index as per your column order
//     case 'recentlyAdded':
//       return new Date(row.cells[17].textContent); // Adjust index as per your column order
//     case 'older':
//       return -new Date(row.cells[17].textContent); // Adjust index as per your column order
//     case 'status':
//       return row.cells[9].textContent.toLowerCase(); // Adjust index as per your column order
//     default:
//       return '';
//   }
// }